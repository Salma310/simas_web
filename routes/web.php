...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['authorize:ADM'])->group(function () {
        Route::group(['prefix' => 'jenis'], function () {
            Route::get('/', [JenisEventController::class, 'index']);
            Route::post('/list', [JenisEventController::class, 'list'])->name('jenis.list');
            Route::get('/create', [JenisEventController::class, 'create']);
            Route::post('/store', [JenisEventController::class, 'store'])->name('jenis.store');
            Route::get('/{id}/edit', [JenisEventController::class, 'edit']);
            Route::put('/{id}/update', [JenisEventController::class, 'update'])->name('jenis.update');
            Route::get('/{id}/delete', [JenisEventController::class, 'confirm']);
            Route::delete('/{id}/delete', [JenisEventController::class, 'delete']);
        });
    });
    ...
    Route::middleware(['authorize:ADM,PMP,DSN'])->group(function () {
