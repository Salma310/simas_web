                        ...
                        <div class="col-md-3">
                            ...
                            <div class="member-info">
                                <img alt="Profile picture of {{ $pic->user->name }}" class="avatar" height="50"
                                     src="{{ $pic->user->picture ? $pic->user->picture : asset('images/defaultUser.png') }}" width="50"/>
                                <p>{{ $pic->user->name }}</p>
                            </div>
                        </div>
                    @endif
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="member-info">
                                <img alt="Profile picture of {{ $pembina->user->name }}" class="avatar" height="50"
                                     src="{{ $pembina->user->picture ? $pembina->user->picture : asset('images/defaultUser.png') }}" width="50"/>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="member-info">
                                <img alt="Profile picture of {{ $sekretaris->user->name }}" class="avatar" height="50"
                                     src="{{ $sekretaris->user->picture ? $sekretaris->user->picture : asset('images/defaultUser.png') }}" width="50"/>
                                ...
                                @foreach($anggota as $member)
                                    <div class="d-flex align-items-center mb-2">
                                        <img alt="Profile picture of {{ $member->user->name }}" class="avatar mr-2" height="40"
                                             src="{{ $member->user->picture ? $member->user->picture : asset('images/defaultUser.png') }}" width="40"/>
